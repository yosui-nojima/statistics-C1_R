...
- hist; ヒストグラムを出力する関数
  ...
  - breaks; 階級の数を指定
### 図の保存方法
1. 右下に図が表示されたのち、下図赤枠のExportをクリック
...
3. 2.推定した区間のうち母数が含まれている区間の数と含まれていなかった区間の数を確認する。

レポートには、e-Statから選択したデータとそのデータのリンク（URL）、実行したRのコード、実行後の出力結果、実行後に出力された図を含めること。\
